  ...
  (props: AboutProps, ref: ForwardedRef<HTMLElement>) => {
    ...
    return (
      <motion.section
        ...
        className="text-4xl border-white rounded-2xl border-[6px] my-8 max-w-6xl bg-slate-800"
      >
        ...
        <div
          className="px-4 flex flex-col md:flex-row-reverse items-center m-auto text-2xl
        ...
        >
          ...
          tenetur sequi provident perferendis porro, ut exercitationem natus,
          dolorum quasi minus, accusantium amet rerum unde. Provident inventore
          optio nulla facilis?
        </div>
        <div
          className="px-4 flex flex-col md:flex-row gap-4 items-center m-auto text-2xl 
        md:text-4xl p-2 sm:p-4"
        >
          <Image
